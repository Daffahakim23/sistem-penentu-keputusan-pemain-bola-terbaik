...
<html lang="en">
  ...
  ?>
    ...
    ?>
        <img class="mb-4" src="assets/images/logo2.png" alt="" width="260" height="72">
        <h1 class="h4 mb-3 font-weight-normal" >FIFA Best Player</h1>
        ...
        <p class="mt-4 mb-3 text-muted">&copy; 2023. FIFA </p>  
      </form>
  <?php
  }
  ?>
