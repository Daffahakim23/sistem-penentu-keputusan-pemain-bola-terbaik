      ...
      <div class="card-header">
         <div class="col-6">
            <select class="custom-select d-block w-50" id="aspek" name="aspek" required>
              ...
              <option value="kecerdasan" <?php echo $_REQUEST['aspek'] == "kecerdasan" ? "selected=selected" : "";?>>Performa</option>
              <option value="wawancara" <?php echo $_REQUEST['aspek'] == "wawancara" ? "selected=selected" : "";?>>Fair Play</option>
          ...
          <div class="container">
            <div id="spninactive_kecerdasan" style="display:none;">
              ...
              <table class="table table-bordered table-striped">
                <thead>
                  <tr>
                    <th>Nama Pemain</th>
                    <th>A1 - Gelar Individu</th>
                    <th>A2 - Gelar Juara Tim</th>
                    <th>A3 - Kontribusi Goal</th>
                    <th>A4 - Penampilan</th>
                  </tr>
                </thead>
                <tbody>
            ...
            <table class="table table-bordered table-striped">
              <thead>
                <tr>
                  <th>Nama Pemain</th>
                  <th>A5 - Kartu Kuning</th>
                  <th>A6 - Kartu Merah</th>
                  <th>A7 - Fouls</th>
                  <th>A8 - Hukuman Larangan Bermain</th>
                </tr>
              </thead>
              <tbody>
                <?php
