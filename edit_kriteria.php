				...
				<div class="col-sm-6 offset-sm-3">
					<div class="form-group">
						...
						<select name="id_aspek" id="id_aspek" class="form-control" required="true">
							<option value="1" <?php if ($id_aspek == "1"){ echo "selected"; } ?>>Performa</option>
							<option value="2" <?php if ($id_aspek == "2"){ echo "selected"; } ?>>Fair Play</option>
							<option value="3" <?php if ($id_aspek == "3"){ echo "selected"; } ?>>Sikap Kerja</option>
						</select>
					</div>
					<div class="form-group">
						<label>Faktor</label>
