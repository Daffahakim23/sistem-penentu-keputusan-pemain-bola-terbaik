...
<div class="panel-heading"><strong>Aspek Performa</strong></div>
<div class="table-responsive">
<table class="table  table-striped table-hover" style="border: 0px;">
<tbody> <tr>
                    <th>Nama Pemain</th>
                    <th>Gelar Individu</th>
                    <th>Gelar Juara Tim</th>
                    <th>Kontribusi Goal</th>
                    <th>Penampilan</th>
                  </tr>
                  <?php
...
<div class="panel panel-default">
<div class="panel-heading"><strong>Aspek Fairplay</strong></div>
<div class="table-responsive">
<table class="table  table-striped table-hover" style="border: 0px;">
<tbody> <tr>
                    <th>Nama Pemain</th>
...
<tbody><tr>
<th>Nama Pemain</th>
<th>Aspek Performa</th>
<th>Aspek Fairplay</th>
<th>Total</th>
<th>Rank</th>
</tr>
<tr>
...
<?php
                    $query = "SELECT mp.id_pelamar,mp.nama_pelamar,pm.A1,pm.A2,pm.A3,pm.A4,pm.A5,pm.A6,pm.A7,pm.A8 FROM master_pelamar mp left JOIN (SELECT * FROM( select id_pelamar,sum( if(id_faktor=1,value,0) ) as 'A1',sum( if(id_faktor=2,value,0) ) as 'A2',sum( if(id_faktor=3,value,0) ) as 'A3',sum( if(id_faktor=4,value,0) ) as 'A4',sum( if(id_faktor=5,value,0) ) as 'A5',sum( if(id_faktor=6,value,0) ) as 'A6',sum( if(id_faktor=7,value,0) ) as 'A7',sum( if(id_faktor=8,value,0) ) as 'A8' from pm_sample group by id_pelamar)tbl) pm on mp.id_pelamar =pm.id_pelamar";
                    //$query ="select * from master_pelamar";
                    $sql = mysqli_query($koneksi, $query);
                    $value1 =cari_nilai("select target as nilai from pm_faktor where id_faktor=1");
                    $value2 =cari_nilai("select target as nilai from pm_faktor where id_faktor=2");
